...
import { 
  Plus, Search, Eye, Edit, Trash2, Github, 
  ExternalLink, Star, Calendar, BarChart
} from 'lucide-react';
          ...
          <div className="flex-1">
            <div className="relative">
              ...
              <Input
                ...
                className={`pl-10 ${isDark ? 'bg-gray-800 border-gray-700 text-white' : 'bg-white border-gray-200'}`}
              />
            </div>
          </div>
                ...
                <Card className={`h-full hover:shadow-lg transition-shadow ${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
                  <CardHeader className="pb-3">
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <CardTitle className={`text-lg line-clamp-1 ${isDark ? 'text-white' : 'text-gray-900'}`}>
                          {tool.name}
                        </CardTitle>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between pt-2 border-t">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <Button size="sm" variant="ghost" className={`p-1 ${isDark ? 'text-red-400 hover:text-red-300' : 'text-red-500 hover:text-red-700'}`}>
